...
import ModifyProfile from '../route/profile/mockmodifyProfile';
...
test('should render enrollment component', () => {
    render(<ReduxProvider reduxStore={store}><Router><ModifyProfile/></Router></ReduxProvider>);
    const loginElement = screen.getByTestId('modProfile-1');
...
test('should render enrollment component', () => {
    render(<ReduxProvider reduxStore={store}><Router><ModifyProfile/></Router></ReduxProvider>);
    const loginElement = screen.getByTestId('makePub-1');
    // const loginElement = screen.getByPlaceholderText("Faculty");
    // const loginElement = screen.getByText("Faculty");
    expect(loginElement).toBeInTheDocument();
} )
...
test('should render enrollment component', () => {
    render(<ReduxProvider reduxStore={store}><Router><ModifyProfile/></Router></ReduxProvider>);
    const loginElement = screen.getByTestId('makePub-2');
    // const loginElement = screen.getByPlaceholderText("Faculty");
    // const loginElement = screen.getByText("Faculty");
    expect(loginElement).toBeInTheDocument();
} )
...
test('should render CreateProfile component', () => {
    render(<ReduxProvider reduxStore={store}><Router><ModifyProfile/></Router></ReduxProvider>);
    const loginElement = screen.getByText("Show me on UWConnect");
    expect(loginElement).toBeInTheDocument();
} )

test('matches snapshot', () => {
    const tree = renderer.create(<ReduxProvider reduxStore={store}><Router><ModifyProfile/></Router></ReduxProvider>).toJSON();
